...
export default function App() {
  ...
  const downloadCSV = () => {
    const headers = ['ID', 'Name', 'Phone', 'Wallet', 'Status', 'Created At', 'Last Visited'];
                ...
                <tr key={u.id} className="border-t hover:bg-gray-50 transition">
                  ...
                  <td className="p-3 relative">
                    ...
                    {openMenuId === u.id && (
                      <div className="absolute z-20 bg-white border rounded-lg shadow-md w-40 mt-2">
                        <button
                          onClick={() => setOpenLoginId(openLoginId === u.id ? null : u.id)}
                  ...
                  <td className="p-3">
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        onClick={() => setShowPhone(showPhone === u.id ? null : u.id)}
                  ...
                  <td className="p-3 font-medium text-gray-800">₹ {u.wallet}</td>
