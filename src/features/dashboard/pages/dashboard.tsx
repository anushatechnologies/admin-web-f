...
const initialOrders: Order[] = [
  { id: "ORD-001", customer: "Rahul Sharma", date: "2026-02-18", amount: 2499, status: "Delivered" },
  { id: "ORD-002", customer: "Priya Patel", date: "2026-02-18", amount: 1899, status: "Out for Delivery" },
